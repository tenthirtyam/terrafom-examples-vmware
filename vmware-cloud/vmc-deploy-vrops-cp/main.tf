...
resource "vsphere_virtual_machine" "cloud_proxy" {
  ...
  vapp {
    properties = {
      "otk"                    = var.cloud_proxy_otk
      "friendly.name"          = var.cloud_proxy_display_name
      "vamitimezone"           = var.cloud_proxy_timezone
      "network_proxy_ip"       = var.cloud_proxy_network_proxy_hostname_ip
      ...
      "ssl"                    = var.cloud_proxy_network_proxy_ssl_enabled
      "ssl_verification"       = var.cloud_proxy_network_proxy_ssl_verification
      "custom_ca"              = var.cloud_proxy_certificate
      ...
      "ntp.server.list"        = var.cloud_proxy_ntp_servers
